...
func (c *userClient) GetInfo(ctx context.Context, in *GetInfoReq, opts ...grpc.CallOption) (*GetInfoRes, error) {
	out := new(GetInfoRes)
...
func (UnimplementedUserServer) GetInfo(context.Context, *GetInfoReq) (*GetInfoRes, error) {
